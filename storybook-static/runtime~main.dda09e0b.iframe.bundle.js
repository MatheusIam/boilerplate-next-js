  ...
  ;(__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done)
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'boilerplate-next-js:' + key
            ) {
              script = s
              break
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 'boilerplate-next-js:' + key),
          (script.src = url)),
          (inProgress[url] = [done])
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkboilerplate_next_js =
