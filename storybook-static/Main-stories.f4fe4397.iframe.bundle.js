'use strict'
;(self.webpackChunkboilerplate_next_js =
  self.webpackChunkboilerplate_next_js || []).push([
  [756],
  {
    './src/components/Main/stories.tsx': (
      ...
      var _templateObject,
        ...
        Main = function Main(_ref) {
          var _ref$title = _ref.title,
            title = void 0 === _ref$title ? 'Nextzão de cria' : _ref$title,
            _ref$description = _ref.description,
            description =
              void 0 === _ref$description
                ? 'Desenvolvido por Matheus Iam'
                : _ref$description
          return __jsx(
            Wrapper,
            null,
            __jsx('h1', null, 'React Avançado'),
            __jsx(Logo, {
              src: '/img/logo.svg',
      ...
      ;(Main.displayName = 'Main'),
        (Main.__docgenInfo = {
          ...
          props: {
            title: {
              defaultValue: { value: "'Nextzão de cria'", computed: !1 },
              required: !1
            },
            description: {
              defaultValue: {
                value: "'Desenvolvido por Matheus Iam'",
                computed: !1
              },
              required: !1
            }
      ...
      try {
        ;(Main.displayName = 'Main'),
          (Main.__docgenInfo = {
            ...
            props: {
              title: {
                defaultValue: { value: 'Nextzão de cria' },
                description: '',
                name: 'title',
                required: !1,
                type: { name: 'string' }
              ...
              description: {
                defaultValue: { value: 'Desenvolvido por Matheus Iam' },
                description: '',
                name: 'description',
                required: !1,
                type: { name: 'string' }
      ...
      var Default = {
        ...
        Novo_Story = { args: { title: 'Eai', description: 'blabla' } }
    }
  }
])
